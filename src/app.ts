...
// const projectState = new ProjectState(); // esto para que se pueda usar la class projectstate desde todos lados o
...
class ProjectInput extends Component<HTMLDivElement, HTMLFormElement> {
  ...
  private gatherUserInput(): [string, string, number] | void {
    ...
    if (
      ...
      return [enteredTitle, enteredDescription, +enteredPeople]; // el + delante es para transformarlo en numero (tambien se puede usar parseFloat por ejemplo)
    }
  }
